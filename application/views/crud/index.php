...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        ...
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#showModal" id="addModal">
            Add Products
        </button>
        ...
        <div class="modal-body">
            <form id="form" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="file" class="form-control" name="file" id="img" accept="image/*">
                    </div>
